...
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0xE0000)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x020E0000)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x0)
#define BSP_PARTITION_FLASH_CPU1_S_START (0x020E0000)
#define BSP_PARTITION_FLASH_CPU1_S_SIZE (0x20000)
