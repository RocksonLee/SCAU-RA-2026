...
uint8_t sub_0025_arena[kArenaSize_sub_0025]
    BSP_PLACE_IN_SECTION(".sdram_nocache") BSP_ALIGN_VARIABLE(32);
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0025_fast_scratch[73728];
uint8_t* sub_0025_fast_scratch = sub_0025_arena;

static void sub_0025_clean_dcache(void) {
  SCB_CleanDCache_by_Addr((uint32_t *) sub_0025_arena,
                          (int32_t) sizeof(sub_0025_arena));
}

static void sub_0025_invalidate_dcache(void) {
  SCB_InvalidateDCache_by_Addr((void *) sub_0025_arena,
                               (int32_t) sizeof(sub_0025_arena));
}
...
int sub_0025_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0025_model with size 38048 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0025_model_data;
  base_addrs_size[0] = sub_0025_model_data_size;
  // Buffer sub_0025_arena with size 73728 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0025_arena+0);
  base_addrs_size[1] = 73728;

  // Buffer sub_0025_fast_scratch with size 73728 and address: 0
  ...
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0025_arena+24576);
  base_addrs_size[3] = 24576;

  // Buffer input_tensor_1 with size 24576 and address: 0
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0025_arena+0);
  base_addrs_size[4] = 24576;

  // Buffer output_tensor_0 with size 12288 and address: 0
  if (clean_outputs) {
    memset(sub_0025_arena + 0, 0, 12288);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0025_arena+0);
