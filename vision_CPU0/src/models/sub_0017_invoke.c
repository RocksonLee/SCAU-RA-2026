...
uint8_t sub_0017_arena[kArenaSize_sub_0017]
    BSP_PLACE_IN_SECTION(".sdram_nocache") BSP_ALIGN_VARIABLE(32);
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0017_fast_scratch[61440];
uint8_t* sub_0017_fast_scratch = sub_0017_arena;

static void sub_0017_clean_dcache(void) {
  SCB_CleanDCache_by_Addr((uint32_t *) sub_0017_arena,
                          (int32_t) sizeof(sub_0017_arena));
}

static void sub_0017_invalidate_dcache(void) {
  SCB_InvalidateDCache_by_Addr((void *) sub_0017_arena,
                               (int32_t) sizeof(sub_0017_arena));
}
...
int sub_0017_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0017_model with size 8976 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0017_model_data;
  base_addrs_size[0] = sub_0017_model_data_size;
  // Buffer sub_0017_arena with size 61440 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0017_arena+0);
  base_addrs_size[1] = 61440;

  // Buffer sub_0017_fast_scratch with size 61440 and address: 0
  ...
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0017_arena+24576);
