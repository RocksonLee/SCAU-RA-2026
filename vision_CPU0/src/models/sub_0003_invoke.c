...
// __attribute__((aligned(16))) static uint8_t sub_0003_fast_scratch[122880];
...
int sub_0003_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0003_model with size 3552 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0003_model_data;
  base_addrs_size[0] = sub_0003_model_data_size;
  // Buffer sub_0003_arena with size 122880 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[1] = 122880;

  // Buffer sub_0003_fast_scratch with size 122880 and address: 0
  ...
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0003_arena+73728);
  base_addrs_size[3] = 49152;

  // Buffer output_tensor_0 with size 49152 and address: 49152
  if (clean_outputs) {
    memset(sub_0003_arena + 49152, 0, 49152);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0003_arena+49152);
