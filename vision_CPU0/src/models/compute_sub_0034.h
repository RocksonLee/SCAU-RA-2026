...
/*
 kBufferSize_sub_0034 is a compile-time constant to be used by the user of compute_sub_0034 function
 ...
 Example of how to call the compute function:
   ...
   uint8_t my_buffer[kBufferSize_sub_0034];

   int main() {
     ...
     compute_sub_0034(my_buffer, input, output);
   }
*/
enum BufferSize_sub_0034 {

#if defined(ARM_MATH_MVEI)
  kBufferSize_sub_0034 = 9
...
void compute_sub_0034(
  // buffer for intermediate results
  uint8_t* main_storage, // should provide at least 9 bytes of storage

  // inputs
  
  const int8_t output_70634_12028[47040], // 1,1344,35
  

  // outputs
  
  float output_70634[47040]  // 1,1344,35
