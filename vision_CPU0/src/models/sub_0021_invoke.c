...
uint8_t sub_0021_arena[kArenaSize_sub_0021]
    BSP_PLACE_IN_SECTION(".sdram_nocache") BSP_ALIGN_VARIABLE(32);
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0021_fast_scratch[61440];
uint8_t* sub_0021_fast_scratch = sub_0021_arena;

static void sub_0021_clean_dcache(void) {
  SCB_CleanDCache_by_Addr((uint32_t *) sub_0021_arena,
                          (int32_t) sizeof(sub_0021_arena));
}

static void sub_0021_invalidate_dcache(void) {
  SCB_InvalidateDCache_by_Addr((void *) sub_0021_arena,
                               (int32_t) sizeof(sub_0021_arena));
}
...
int sub_0021_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0021_model with size 8960 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0021_model_data;
  base_addrs_size[0] = sub_0021_model_data_size;
  // Buffer sub_0021_arena with size 61440 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0021_arena+0);
  base_addrs_size[1] = 61440;

  // Buffer sub_0021_fast_scratch with size 61440 and address: 0
  ...
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0021_arena+24576);
  base_addrs_size[3] = 24576;

  // Buffer output_tensor_0 with size 24576 and address: 24576
  if (clean_outputs) {
    memset(sub_0021_arena + 24576, 0, 24576);
  }
